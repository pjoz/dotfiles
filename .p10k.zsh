# Generated by Powerlevel10k configuration wizard on 2021-03-18 at 21:08 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    battery                 # status of battery charge
  ...
  #####################################[ date: current date ]###################################
  # Make date foreground color work with Solarized Dark
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=11
